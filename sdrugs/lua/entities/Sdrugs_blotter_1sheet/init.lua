...
function ENT:Initialize()
 self:SetModel("models/sdrugs/blotter/1sheet.mdl")
 ...
 timer.Simple(0.1,function()
  local sheet1=self
  local data=sheet1:GetNWString("SDrugs_blotter_data","sdrugs_blotter_-sdrugs/blotters/bycicle_day-1-1")
  ...
  net.WriteString("sdrugs_1sheet_10".."-"..tmaterial[#tmaterial].."-"..tostring(matpos).."-"..tostring(x).."-"..tostring(i))
...
function ENT:Use( activator, caller )
 ...
 net.WriteInt(self:GetNWInt("SDrugs_quantity",100),32)
 net.Send(caller)
 self:Remove()
 end
end
